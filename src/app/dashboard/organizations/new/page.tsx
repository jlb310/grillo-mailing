        ...
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-sm text-foreground-muted">Nombre</Label>
              <Input
                id="name"
                value={formData.name}
                onChange={(e) => {
            ...
            <div className="space-y-2">
              <Label htmlFor="slug" className="text-sm text-foreground-muted">Slug (identificador único)</Label>
              <Input
                id="slug"
                value={formData.slug}
            ...
            <div className="space-y-2">
              <Label htmlFor="description" className="text-sm text-foreground-muted">Descripción (opcional)</Label>
              <Textarea
                id="description"
