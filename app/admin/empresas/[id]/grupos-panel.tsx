...
export default function GruposPanel({ empresaId, groups, totalContacts, ungroupedCount }: GruposPanelProps) {
  ...
  async function crearGrupo() {
    ...
    setSaving(true);
    await fetch(`/api/empresas/${empresaId}/grupos`, {
      method: "POST",
  ...
  async function eliminarGrupo(groupId: string) {
    ...
    await fetch(`/api/empresas/${empresaId}/grupos/${groupId}`, { method: "DELETE" });
    router.refresh();
  }
        ...
        <div className="flex items-center justify-between pt-1 px-1">
          ...
          <button
            ...
            onClick={async () => {
              ...
              const res = await fetch(`/api/empresas/${empresaId}/contactos`, { method: "DELETE" });
              const data = await res.json();
